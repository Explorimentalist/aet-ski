...
- `src/hooks/usePortalDropdown.ts` - Core hook for portal dropdown positioning and rendering logic (✅ Created - comprehensive hook with smart positioning, event handling, and fallback support)
...
- `src/components/Calendar.tsx` - Existing calendar component to migrate to portal system
- `src/components/Calendar.test.tsx` - Updated tests for Calendar with portal behavior
- `src/components/TimeSelector.tsx` - Existing time selector component to migrate to portal system  
- `src/components/TimeSelector.test.tsx` - Updated tests for TimeSelector with portal behavior
...
- [x] 1.0 Create reusable portal dropdown hook with positioning logic
  ...
  - [x] 1.3 Create `usePortalDropdown` hook in `src/hooks/usePortalDropdown.ts` with smart positioning logic
...
- [ ] 2.0 Migrate Calendar component to use portal dropdown system
  - [ ] 2.1 Integrate `usePortalDropdown` hook into Calendar component
  - [ ] 2.2 Replace existing absolute positioning with portal rendering at z-[70]
  - [ ] 2.3 Preserve existing animations and styling while using portal
  - [ ] 2.4 Ensure click-outside detection works with portal rendering
  - [ ] 2.5 Test Calendar positioning edge cases (near viewport boundaries)
  - [ ] 2.6 Update Calendar component tests to cover portal behavior

- [ ] 3.0 Migrate TimeSelector component to use portal dropdown system
  - [ ] 3.1 Integrate `usePortalDropdown` hook into TimeSelector component
  - [ ] 3.2 Replace existing absolute positioning with portal rendering at z-[70]
  - [ ] 3.3 Preserve existing scrollable time list functionality in portal
  - [ ] 3.4 Ensure TimeSelector animations work correctly with portal
  - [ ] 3.5 Test TimeSelector positioning with long time lists
  - [ ] 3.6 Update TimeSelector component tests to cover portal behavior
