...
describe('ReviewForm', () => {
  ...
  it('shows validation errors on submit when fields are empty', () => {
    ...
    expect(screen.getAllByText(/name is required/i)[0]).toBeInTheDocument();
  ...
  it('submits valid data', () => {
    ...
    // Fill booking name, name and comment
    fireEvent.change(screen.getByLabelText(/lead passenger booking name/i), { target: { value: 'John Smith' } });
